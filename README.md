...
```
cd existing_repo
git remote add origin https://gitlab.com/Novimatrem/batch-alarm-clock.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Novimatrem/batch-alarm-clock/-/settings/integrations)
